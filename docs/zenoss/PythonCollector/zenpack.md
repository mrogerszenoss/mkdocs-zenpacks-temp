...
runningtimeout:   Timeout datasource collection that exceeds (runningtimeout \*
...
-   *percentBlocked*: Percent of the time blocked by plugin code
    execution.
...
Assuming you have a ZenPack named ZenPacks.example.PackName you would
